(defparameter *nodes* '((BRUN404 (You are in a small room filled with functional programmers. See how "I" did not make a joke about room not found))
                        ...
                        (BRUN213 (You a man wearing glasses staring back at you. There is a book on genetic algorithms and another on AI))
			(BRUN214 (You see a lady studying a book on Scala.))
			(BRUN206 (You see a young man wearing a shirt that reads - "I" love "Assembly." You see a book labeled "Asssembly is Fun."))
))
